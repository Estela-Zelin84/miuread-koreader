...
local M = {
["MiuRead"]="觅阅 · 微信读书助手",["Independent WeRead client for KOReader."]="独立实现的 KOReader 微信读书客户端。",["Free non-commercial WeRead client for KOReader. Selling modified versions is prohibited."]="免费的非商业 KOReader 微信读书客户端，任何修改版均不得售卖。",
